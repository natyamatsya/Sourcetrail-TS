...
struct contiguous_iterator : public base_contiguous_iterator<T, Container>
{
	...
	constexpr contiguous_iterator(pointer it) noexcept
		: m_current(it)
	{
	}
	...
	constexpr difference_type operator-(contiguous_iterator other) const noexcept { return m_current - other.m_current; }
